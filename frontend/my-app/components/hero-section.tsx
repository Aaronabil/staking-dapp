                    ...
                    <div className="pb-24 pt-12 md:pb-32 lg:pb-56 lg:pt-44">
                        <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
                            ...
                            <Image
                                ...
                                src="https://github.com/Aaronabil/staking-dapp/blob/main/frontend/my-app/public/crystal.jpg?raw=true"
                                alt="Abstract Object"
                                height="4000"
                                width="3000"
                            />
                                ...
                                <InfiniteSlider
                                    ...
                                    <div className="flex">
                                        <img
                                            ...
                                            src="https://github.com/Aaronabil/staking-dapp/blob/main/frontend/my-app/public/etherscanblack.svg?raw=true"
                                            alt="Etherscan Logo"
                                            height="28"
                                            width="auto"
                                        />
                                    ...
                                    <div className="flex">
                                        <img
                                            className="mx-auto h-8 w-fit dark:invert"
                                            src="https://github.com/Aaronabil/staking-dapp/blob/main/frontend/my-app/public/hardhatblack.svg?raw=true"
                                            alt="Hardhat Logo"
                                            height="32"
                                            width="auto"
                                        />
